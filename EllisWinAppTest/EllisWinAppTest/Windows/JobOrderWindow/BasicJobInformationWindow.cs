...
namespace EllisWinAppTest.Windows.JobOrderWindow
{
    internal class BasicJobInformationWindow : AppContext
    {
        ...
        public static void EnterBasicJobInformationWindowData(DataRow data)
        {
            ...
            //if (!string.IsNullOrEmpty(data.ItemArray[16].ToString()))
            //    DropDownActions.SelectFromDropDown(getBasicJobInformationControlCollection,
            //        BasicJobInformaionConstants.OrderPlacedBy, data.ItemArray[13].ToString());
            //if (!string.IsNullOrEmpty(data.ItemArray[16].ToString()))
            //   DropDownActions.SelectFromDropDown(getBasicJobInformationControlCollection, BasicJobInformaionConstants.JobDuty,
            //        data.ItemArray[14].ToString());
            //if (!string.IsNullOrEmpty(data.ItemArray[16].ToString()))
            //   DropDownActions.SelectFromDropDown(getBasicJobInformationControlCollection,
            //        BasicJobInformaionConstants.JobSitesList, data.ItemArray[22].ToString());
            ...
            //foreach (var control in getBasicJobInformationEditControlCollection)
            //{
            //    if (control.FriendlyName != null)
            //    {
            //        switch (control.FriendlyName.ToString())
            //        {
            //            case BasicJobInformaionConstants.PoNumber:
            //                control.SetFocus();
            //                SendKeys.SendWait("");
            //                SendKeys.SendWait(data.ItemArray[15].ToString());
            ...
            //            case BasicJobInformaionConstants.CustomerProjectName:
            //                Actions.SetText(control, data.ItemArray[19].ToString());
            //                break;

            //            case BasicJobInformaionConstants.CustomerCostCentre:
            //                Actions.SetText(control, data.ItemArray[18].ToString());
            //                break;

            //            case BasicJobInformaionConstants.JobSiteName:
            //                Actions.SetText(control, data.ItemArray[23].ToString());
            //                break;

            //            case BasicJobInformaionConstants.AddressLine1:
            //                Actions.SetText(control, data.ItemArray[25].ToString());
            //                break;

            //            case BasicJobInformaionConstants.AddressLine2:
            //                Actions.SetText(control, data.ItemArray[26].ToString());
            //                break;
