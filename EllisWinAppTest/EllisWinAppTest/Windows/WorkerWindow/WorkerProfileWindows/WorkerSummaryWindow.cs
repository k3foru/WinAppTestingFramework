...
namespace EllisWinAppTest.Windows.WorkerWindow.WorkerProfileWindows
{
    public class WorkerSummaryWindow : AppContext
    {
        ...
        public static bool SelectWorkerFromTable()
        {
            var status = TableActions.OpenRecordFromTable(EllisWindow, "grdDispatchedWorkers", "Name", "Aaron, Jensen");
            //var cell = TableActions.SelectCellFromTable(EllisWindow, "grdDispatchedWorkers",
            //    "WorkerSearchResultDomain row 1", "Name");
            //Globals.WorkerName = cell.Value;
        ...
        public static bool ClickOnCloseBtn()
        {
            ...
            {
                //var closeBtn = Actions.GetWindowChild(workerProfileWindow, WorkerSummaryTabConstants.CloseBtn);
