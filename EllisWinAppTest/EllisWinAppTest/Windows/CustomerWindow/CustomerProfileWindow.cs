...
namespace EllisWinAppTest.Windows.CustomerWindow
{
    public class CustomerProfileWindow : AppContext
    {
        ...
        private static UITestControl GetCustomerContactInfoWindowProperties()
        {
        ...
        private static UITestControl GetCustomerInvoiceWindowProperties()
        {
            var window =
        ...
        {
            if (VerifyExistingCustomerWindowDisplayed())
            {
                return true;
            }
        ...
        public static bool VerifyProfileDefaults()
        {
            ...
            var nameEdit = nameDBA.Container.SearchFor<WinEdit>(new {Name = Globals.CustomerName});
        ...
        public static void SelectFirstCustomerFromTable()
        {
            ...
            //var tableName = Actions.GetWindowChild(EllisWindow, CProfileControls.CustomersGrid);
            //var table = (WinTable) tableName;
            //var row = table.Container.SearchFor<WinRow>(new {Name = "CustomerQuoteSummaryDomain row 1"});
        ...
        public static void SelectFirstCustomerContactFromTable()
        {
            ...
            //var tableName = Actions.GetWindowChild(cProfileWindow, CProfileControls.SearchResultGrid);
            //var table = (WinTable) tableName;
            //var row = table.Container.SearchFor<WinRow>(new {Name = CProfileControls.SearchResultRow + 1});
            //var cell = row.Container.SearchFor<WinCell>(new {Name = "Name"});
        ...
        {
            var cProfileWindow = GetCustomerProfileWindowProperties();
            //var workCompWin = Actions.GetWindowChild(cProfileWindow, CProfileControls.WorkersComp);
            //var workBtn = workCompWin.Container.SearchFor<WinButton>(new {Name = "Worker\'s Comp"});
            //Mouse.Click(workBtn);
        ...
        public static void ClickSelectOrganizationButton()
        {
            ...
            //var selectBtn = Actions.GetWindowChild(cProfileWindow, CProfileControls.AddOrganization);
            //var selectButton = selectBtn.Container.SearchFor<WinButton>(new {Name = "Select"});
        ...
        public static void SelectAllOrganizationDetails()
        {
            ...
            DropDownActions.SelectDropdownByText(orgType, "Branch");

            var org = Actions.GetWindowChild(selectOrgWindow, CProfileControls.Organization);
            DropDownActions.SelectDropdownByText(org, "1111");
        ...
        {
            var cWorkComp = GetWorkersCompWindowProperties();
            //var codeCancel = Actions.GetWindowChild(cWorkComp, CProfileControls.WorkersCompCancel);
            //var btn = (WinButton) codeCancel;
            //Mouse.Click(btn);
        ...
        public static void ClickAddNoteButton()
        {
            ...
            //var addNote = Actions.GetWindowChild(cProfileWindow, CProfileControls.AddNote);
            //var addNoteBtn = addNote.Container.SearchFor<WinButton>(new {Name = "Add Note"});
            //Mouse.Click(addNoteBtn);
        }
        ...
        {
            var addNoteWindow = GetAddNoteWindowProperties();
            MouseActions.ClickButton(addNoteWindow, CProfileControls.Save);
        }
        ...
        public static bool VerifyNewNoteDisplayedInGrid(string note)
        {
            ...
            //var table = (WinTable) tableName;
            //var row = table.Container.SearchFor<WinRow>(new {Name = CProfileControls.NotesTable});
            //var cell = row.Container.SearchFor<WinCell>(new {Name = "Note"});
            ...
            return noteDisplayed.Equals(note);
        }
        ...
        {
            var cProfileWindow = GetCustomerProfileWindowProperties();
            //var clear = Actions.GetWindowChild(cProfileWindow, CProfileControls.Clear);
            //var clearBtn = clear.Container.SearchFor<WinButton>(new {Name = "Clear"});
            //Mouse.Click(clearBtn);
        ...
        public static void ClickCreditInfoInnerTab(string tabName)
        {
            var cProfileWindow = GetCustomerProfileWindowProperties();
        ...
        {
            var selectOrgWindow = GetSelectOrgWindowProperties();
            Actions.SetCheckBox(selectOrgWindow, CProfileControls.InvoicingOrg, "False");
        ...
        public static bool VerifyPrimaryOrgUnitDisplayed()
        {
            ...
            return org.DisplayText.Contains("Test EllisCSR");
        }
        ...
        {
            //var dofFindFile = GetDOFFindFileWindowProperties();
            //TitlebarActions.ClickClose(GlobalWindows.DocumentOnFileFindFileWindow);
            //var dofFF = dofFindFile.Container.SearchFor<WinWindow>(new {ControlId = "2"});
            //var cancelbtn = dofFF.Container.SearchFor<WinButton>(new { Name = "Cancel" });
        ...
        public static void SelectFirstQuoteFromResults()
        {
            var cProfile = GetCustomerProfileWindowProperties();
            var cell = TableActions.SelectCellFromTable(cProfile, CProfileControls.QuoteSummary,
                "QuoteGridDisplayDomain row 1", "Quoted By");
        ...
        public static void ClickChangeQuoteCustomerName()
        {
        ...
        public static void SelectFirstJobOrderFromResults()
        {
            ...
            //var tableName = Actions.GetWindowChild(cProfile, CProfileControls.JobOrderSummary);
            //var table = (WinTable) tableName;

            //var row = table.Container.SearchFor<WinRow>(new {Name = "CustomerJobOrderSummaryDomain row 1"});
        ...
        public static bool VerifyWorkersDisplayed()
        {
            ...
            //var row = table.Container.SearchFor<WinRow>(new { Name = "DispatchWorkerListDomain row 1" });
            //var cell = row.Container.SearchFor<WinCell>(new { Name = "Name" });
            //Globals.Temp = cell.Value;
            //MouseActions.DoubleClick(cell);
        }
        ...
        {
            var cProfileWindow = GetCustomerProfileWindowProperties();
            var cprofileTabs = Actions.GetWindowChild(cProfileWindow, CProfileControls.InvTab);
            var pfTab = cprofileTabs.Container.SearchFor<WinTabPage>(new { Name = tabName });
            MouseActions.Click(pfTab);
        }
        ...
        public static bool VerifyChainLinkDisplayed()
        {
            Thread.Sleep(3000);
            var window = GetCustomerProfileWindowProperties();
            //var control = window.Container.SearchFor<WinWindow>(new { Name = CProfileControls.ChainLink }, new { ControlType = "Image" });
            var control2 = window.Container.SearchFor<WinControl>(new { Name = CProfileControls.ChainLink });
        ...
        public static bool VerifyQuotingCheckboxesChecked()
        {
            var window = GetCustomerProfileWindowProperties();
            var management = window.Container.SearchFor<WinWindow>(new { Name = CCTabConstants.ManageQuotes })
                .Container.SearchFor<WinCheckBox>(new { Name = "Only Account Manager permitted to Manage Quotes:" });
            var rate = window.Container.SearchFor<WinWindow>(new { Name = CCTabConstants.RateAgreementWindow })
                .Container.SearchFor<WinCheckBox>(new { Name = "Rate Agreement On File:" });

            Actions.SetCheckBox(management, "True");
            Actions.SetCheckBox(rate, "True");
        ...
        public static bool VerifyInvOrgDisplayed()
        {
            ...
            if (control.FriendlyName.Equals("1111 - PUYALLUP BRANCH"))
                return true;
            return false;
        }
