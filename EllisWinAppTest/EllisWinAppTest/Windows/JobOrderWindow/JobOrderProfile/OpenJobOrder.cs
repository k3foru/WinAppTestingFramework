    ...
    internal class OpenJobOrder : AppContext
    {
        ...
        public static void CloseJobOrderProfile()
        {
            ...
            if (profileWindow.Exists)
                Factory.ClickOnButton(profileWindow, "Close");
        }
        ...
        public static void EditSafetyOfJobOrder(DataRow data)
        {
            ...
            if (windowInst.Exists)
            {
                ...
                var radioYesBtnList = windowInst.Container.SearchFor<WinRadioButton>(new { Name = "Yes" });
                var radioNoBtnList = windowInst.Container.SearchFor<WinRadioButton>(new { Name = "No" });

                if (data.ItemArray[82].ToString() == "Yes")
                    Actions.SelectRadioButton(radioYesBtnList, "_optWrittenSafetyProgram");
                if (data.ItemArray[83].ToString() == "Yes")
                    Actions.SelectRadioButton(radioYesBtnList, "_optCustomerSafetyProgram");
                if (data.ItemArray[84].ToString() == "Yes")
                    Actions.SelectRadioButton(radioYesBtnList, "_optPPE");
                if (data.ItemArray[85].ToString() == "Yes")
                    Actions.SelectRadioButton(radioYesBtnList, "_optSpecialisedTraining");
                if (data.ItemArray[86].ToString() == "Yes")
                    Actions.SelectRadioButton(radioYesBtnList, "_optElevatedSurface");
                if (data.ItemArray[87].ToString() == "Yes")
                    Actions.SelectRadioButton(radioYesBtnList, "_optHazardousMaterials");
                if (data.ItemArray[88].ToString() == "Yes")
                    Actions.SelectRadioButton(radioYesBtnList, "_optTrenchWork");
                if (data.ItemArray[89].ToString() == "Yes")
                    Actions.SelectRadioButton(radioYesBtnList, "_optConfinedSpace");
                if (data.ItemArray[90].ToString() == "Yes")
                    Actions.SelectRadioButton(radioYesBtnList, "_optMovingMachinery");
                if (data.ItemArray[91].ToString() == "Yes")
                    Actions.SelectRadioButton(radioYesBtnList, "_optWorkersOnsite");

                if (data.ItemArray[82].ToString() == "No")
                    Actions.SelectRadioButton(radioNoBtnList, "_optWrittenSafetyProgram");
                if (data.ItemArray[83].ToString() == "No")
                    Actions.SelectRadioButton(radioNoBtnList, "_optCustomerSafetyProgram");
                if (data.ItemArray[84].ToString() == "No")
                    Actions.SelectRadioButton(radioNoBtnList, "_optPPE");
                if (data.ItemArray[85].ToString() == "No")
                    Actions.SelectRadioButton(radioNoBtnList, "_optSpecialisedTraining");
                if (data.ItemArray[86].ToString() == "No")
                    Actions.SelectRadioButton(radioNoBtnList, "_optElevatedSurface");
                if (data.ItemArray[87].ToString() == "No")
                    Actions.SelectRadioButton(radioNoBtnList, "_optHazardousMaterials");
                if (data.ItemArray[88].ToString() == "No")
                    Actions.SelectRadioButton(radioNoBtnList, "_optTrenchWork");
                if (data.ItemArray[89].ToString() == "No")
                    Actions.SelectRadioButton(radioNoBtnList, "_optConfinedSpace");
                if (data.ItemArray[90].ToString() == "No")
                    Actions.SelectRadioButton(radioNoBtnList, "_optMovingMachinery");
                if (data.ItemArray[91].ToString() == "No")
                    Actions.SelectRadioButton(radioNoBtnList, "_optWorkersOnsite");
